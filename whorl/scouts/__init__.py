...
from ..core.models import Signal, SignalClass
...
def run_sweep() -> None:
    ...
    for feed_url in feeds:
        ...
        # NOTE: RSS feed ingestion was never built here. The modern
        # ShipWrekDOS scout swarm (whorl/runtime/behaviors.py) supersedes
        # this legacy scaffold — scouts now persist findings to the
        # ContextDrive and recall across sessions. See ROADMAP Q1.5.
